...
public class MainActivity extends AppCompatActivity {
    ...
    public void Registrar(View view){
        ...
        if(!codigo.isEmpty() && !descripcion.isEmpty() && !precio.isEmpty()){
            ...
            Toast.makeText(this, "Registro totalmente exitoso", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(this, "Debes completar todos los campos para continuar", Toast.LENGTH_SHORT).show();
        }
    }
